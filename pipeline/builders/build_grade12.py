  ...
  "chapters": [
    {
      ...
      "summary": {
        ...
        "keyFormulas": [
          ...
          { "label": "Jumlah n Suku Aritmetika", "formula": "S_n = \\frac{n}{2}[2a + (n - 1)b] = \\frac{n}{2}(a + U_n)" },
          { "label": "Suku ke-n Geometri", "formula": "U_n = a \\cdot r^{n-1}" },
          { "label": "Deret Geometri Tak Hingga", "formula": "S_\\infty = \\frac{a}{1 - r} \\quad (|r| < 1)" },
          { "label": "Panjang Lintasan Bola Memantul", "formula": "S_{\\text{total}} = h_0 \\cdot \\frac{q + p}{q - p} \\quad \\left(r = \\frac{p}{q}\\right)" },
          { "label": "Bunga Tunggal", "formula": "M_t = M_0(1 + it) \\quad \\text{dengan } B = M_0 \\cdot i \\cdot t" }
        ],
        "misconceptions": [
      ...
      "questions": [
        ...
        },
        {
          ...
          "options": [
            { "key": "A", "text": "720 orang" },
            { "key": "B", "text": "680 orang" },
            { "key": "C", "text": "750 orang" },
            { "key": "D", "text": "640 orang" }
          ],
          "correctAnswer": "A",
    ...
    },
    {
      ...
      "summary": {
        ...
        "keyFormulas": [
          { "label": "Modal Akhir Bunga Majemuk", "formula": "M_n = M_0(1 + i)^n" },
          { "label": "Bunga Majemuk Periode m Kali Setahun", "formula": "M_t = M_0\\left(1 + \\frac{j}{m}\\right)^{m \\cdot t}" },
          { "label": "Komposisi Anuitas", "formula": "A = a_n + b_n \\quad (A \\text{ konstan})" },
          { "label": "Besaran Anuitas Pelunasan", "formula": "A = \\frac{M \\cdot i}{1 - (1 + i)^{-n}}" },
          { "label": "Hubungan Angsuran Pokok", "formula": "a_n = a_1(1 + i)^{n-1}" },
          { "label": "Depresiasi Eksponensial", "formula": "V_n = V_0(1 - r)^n" }
        ],
        "misconceptions": [
      ...
      "questions": [
        {
          ...
          "options": [
            { "key": "A", "text": "$\\text{Rp}6.050.000,00$" },
            { "key": "B", "text": "$\\text{Rp}6.000.000,00$" },
            { "key": "C", "text": "$\\text{Rp}5.500.000,00$" },
            { "key": "D", "text": "$\\text{Rp}6.100.000,00$" }
          ],
          "correctAnswer": "A",
        ...
        },
        {
          ...
          "options": [
            { "key": "A", "text": "$\\text{Rp}250.000,00$" },
            { "key": "B", "text": "$\\text{Rp}300.000,00$" },
            { "key": "C", "text": "$\\text{Rp}200.000,00$" },
            { "key": "D", "text": "$\\text{Rp}150.000,00$" }
          ],
          "correctAnswer": "A",
        ...
        },
        {
          ...
          "options": [
            { "key": "A", "text": "$\\text{Rp}1.575.000,00$" },
            { "key": "B", "text": "$\\text{Rp}1.600.000,00$" },
            { "key": "C", "text": "$\\text{Rp}1.550.000,00$" },
            { "key": "D", "text": "$\\text{Rp}1.650.000,00$" }
          ],
          "correctAnswer": "A",
        ...
        },
        {
          ...
          "options": [
            { "key": "A", "text": "$\\text{Rp}20.250.000,00$" },
            { "key": "B", "text": "$\\text{Rp}20.000.000,00$" },
            { "key": "C", "text": "$\\text{Rp}22.500.000,00$" },
            { "key": "D", "text": "$\\text{Rp}19.500.000,00$" }
          ],
          "correctAnswer": "A",
        ...
        },
        {
          ...
          "options": [
            { "key": "A", "text": "$\\text{Rp}13.850.000,00$" },
            { "key": "B", "text": "$\\text{Rp}13.625.000,00$" },
            { "key": "C", "text": "$\\text{Rp}14.000.000,00$" },
            { "key": "D", "text": "$\\text{Rp}13.775.000,00$" }
          ],
          "correctAnswer": "A",
    ...
    },
    {
      ...
      "summary": {
        ...
        "keyFormulas": [
          { "label": "Permutasi n Objek Berlainan", "formula": "P(n, r) = \\frac{n!}{(n - r)!} \\quad (r \\le n)" },
          { "label": "Kombinasi n Objek", "formula": "C(n, r) = \\binom{n}{r} = \\frac{n!}{r!(n - r)!}" },
          { "label": "Permutasi Unsur Sama", "formula": "P = \\frac{n!}{k_1! \\cdot k_2! \\dots k_m!}" },
          { "label": "Permutasi Siklis", "formula": "P_{\\text{siklis}} = (n - 1)!" },
          { "label": "Aturan Perkalian Bersyarat", "formula": "K = n_1 \\times n_2 \\times \\dots \\times n_k" }
        ],
        "misconceptions": [
    ...
    },
    {
      ...
      "summary": {
        ...
        "keyFormulas": [
          { "label": "Peluang Teoritik Dasar", "formula": "P(A) = \\frac{n(A)}{n(S)} \\quad (0 \\le P(A) \\le 1)" },
          { "label": "Komplemen Kejadian", "formula": "P(A') = 1 - P(A)" },
          { "label": "Peluang Kejadian Saling Lepas", "formula": "P(A \\cup B) = P(A) + P(B) \\quad (A \\cap B = \\emptyset)" },
          { "label": "Peluang Tidak Saling Lepas", "formula": "P(A \\cup B) = P(A) + P(B) - P(A \\cap B)" },
          { "label": "Kejadian Saling Bebas", "formula": "P(A \\cap B) = P(A) \\cdot P(B)" },
          { "label": "Peluang Bersyarat", "formula": "P(A|B) = \\frac{P(A \\cap B)}{P(B)} \\quad (P(B) > 0)" }
        ],
        "misconceptions": [
...
with open('src/data/grades/grade12.js', 'w', encoding='utf-8') as f:
    f.write(fileContent)

print("Successfully generated upgraded src/data/grades/grade12.js!")

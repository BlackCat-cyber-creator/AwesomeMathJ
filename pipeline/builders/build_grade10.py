  ...
  "chapters": [
    {
      ...
      "summary": {
        ...
        "keyFormulas": [
          { "label": "Definisi Logaritma", "formula": "a^c = b \\iff {}^a\\log b = c \\quad (a > 0, a \\neq 1, b > 0)" },
          { "label": "Sifat Penjumlahan Logaritma", "formula": "{}^a\\log x + {}^a\\log y = {}^a\\log(x \\cdot y)" },
          { "label": "Sifat Pengurangan Logaritma", "formula": "{}^a\\log x - {}^a\\log y = {}^a\\log\\left(\\frac{x}{y}\\right)" },
          { "label": "Merasionalkan Akar Binomial", "formula": "\\frac{c}{\\sqrt{a} + \\sqrt{b}} = \\frac{c(\\sqrt{a} - \\sqrt{b})}{a - b}" },
          { "label": "Model Pertumbuhan Eksponensial", "formula": "N(t) = N_0 \\cdot a^{kt}" }
        ],
        "misconceptions": [
      ...
      "questions": [
        ...
        },
        {
          ...
          "options": [
            { "key": "A", "text": "$\\frac{a^2 \\cdot c^6}{b^5}$" },
            { "key": "B", "text": "$\\frac{a^4 \\cdot c^4}{b}$" },
            { "key": "C", "text": "$a^2 \\cdot b^5 \\cdot c^6$" },
            { "key": "D", "text": "$\\frac{a^2 \\cdot c^4}{b^5}$" }
          ],
          "correctAnswer": "A",
        ...
        },
        {
          ...
          "options": [
            { "key": "A", "text": "$2\\sqrt{7} + 2\\sqrt{3}$" },
            { "key": "B", "text": "$2\\sqrt{7} - 2\\sqrt{3}$" },
            { "key": "C", "text": "$4\\sqrt{7} + 4\\sqrt{3}$" },
            { "key": "D", "text": "\\sqrt{7} + \\sqrt{3}" }
          ],
          "correctAnswer": "A",
    ...
    },
    {
      ...
      "summary": {
        ...
        "keyFormulas": [
          { "label": "Suku ke-n Aritmetika", "formula": "U_n = a + (n - 1)b" },
          { "label": "Jumlah n Suku Aritmetika", "formula": "S_n = \\frac{n}{2}[2a + (n - 1)b]" },
          { "label": "Suku ke-n Geometri", "formula": "U_n = a \\cdot r^{n-1}" },
          { "label": "Deret Geometri Tak Hingga", "formula": "S_\\infty = \\frac{a}{1 - r} \\quad (|r| < 1)" }
        ],
        "misconceptions": [
    ...
    },
    {
      ...
      "summary": {
        ...
        "keyFormulas": [
          { "label": "Panjang Vektor", "formula": "|\\vec{u}| = \\sqrt{x^2 + y^2}" },
          { "label": "Vektor Satuan", "formula": "\\vec{e} = \\frac{\\vec{u}}{|\\vec{u}|}" },
          { "label": "Perkalian Skalar Dot Product", "formula": "\\vec{u} \\cdot \\vec{v} = x_1 x_2 + y_1 y_2 = |\\vec{u}||\\vec{v}|\\cos\\theta" },
          { "label": "Syarat Ortogonalitas (Tegak Lurus)", "formula": "\\vec{u} \\cdot \\vec{v} = 0" }
        ],
        "misconceptions": [
      ...
      "questions": [
        {
          ...
          "options": [
            { "key": "A", "text": "13 satuan" },
            { "key": "B", "text": "17 satuan" },
            { "key": "C", "text": "7 satuan" },
            { "key": "D", "text": "15 satuan" }
          ],
          "correctAnswer": "A",
        ...
        },
        {
          ...
          "options": [
            { "key": "A", "text": "$\\begin{pmatrix} 8 \\\\ -5 \\end{pmatrix}$" },
            { "key": "B", "text": "$\\begin{pmatrix} 6 \\\\ -2 \\end{pmatrix}$" },
            { "key": "C", "text": "$\\begin{pmatrix} 8 \\\\ -7 \\end{pmatrix}$" },
            { "key": "D", "text": "$\\begin{pmatrix} 10 \\\\ -5 \\end{pmatrix}$" }
          ],
          "correctAnswer": "A",
    ...
    },
    {
      ...
      "summary": {
        ...
        "keyFormulas": [
          { "label": "Perbandingan Dasar Siku-Siku", "formula": "\\sin\\alpha = \\frac{\\text{de}}{\\text{mi}}, \\; \\cos\\alpha = \\frac{\\text{sa}}{\\text{mi}}, \\; \\tan\\alpha = \\frac{\\text{de}}{\\text{sa}}" },
          { "label": "Aturan Sinus", "formula": "\\frac{a}{\\sin A} = \\frac{b}{\\sin B} = \\frac{c}{\\sin C}" },
          { "label": "Aturan Kosinus", "formula": "a^2 = b^2 + c^2 - 2bc\\cos A" }
        ],
        "misconceptions": [
      ...
      "questions": [
        ...
        },
        {
          ...
          "options": [
            { "key": "A", "text": "$20\\sqrt{3}\\text{ meter}$" },
            { "key": "B", "text": "$\\frac{20}{3}\\sqrt{3}\\text{ meter}$" },
            { "key": "C", "text": "$40\\text{ meter}$" },
            { "key": "D", "text": "$20\\text{ meter}$" }
          ],
          "correctAnswer": "A",
        ...
        },
        {
          ...
          "options": [
            { "key": "A", "text": "$2\\sqrt{21}\\text{ cm}$" },
            { "key": "B", "text": "$2\\sqrt{19}\\text{ cm}$" },
            { "key": "C", "text": "$\\sqrt{84}\\text{ cm}$" },
            { "key": "D", "text": "$6\\text{ cm}$" }
          ],
          "correctAnswer": "A",
    ...
    },
    {
      ...
      "summary": {
        ...
        "keyFormulas": [
          { "label": "Bentuk Baku SPLTV", "formula": "a_i x + b_i y + c_i z = d_i \\quad (i = 1, 2, 3)" },
          { "label": "Pertidaksamaan Linear Garis Pembatas", "formula": "ax + by = c" }
        ],
        "misconceptions": [
      ...
      "questions": [
        ...
        },
        {
          ...
          "options": [
            ...
            { "key": "C", "text": "Rp10.500,00" },
            { "key": "D", "text": "Rp13.000,00" }
          ],
          "correctAnswer": "A",
    ...
    },
    {
      ...
      "summary": {
        ...
        "keyFormulas": [
          { "label": "Diskriminan", "formula": "D = b^2 - 4ac" },
          { "label": "Sumbu Simetri", "formula": "x_p = -\\frac{b}{2a}" },
          { "label": "Nilai Optimum Ekstrim", "formula": "y_p = -\\frac{D}{4a}" }
        ],
        "misconceptions": [
    ...
    },
    {
      ...
      "summary": {
        ...
        "keyFormulas": [
          { "label": "Mean Data Berkelompok", "formula": "\\bar{x} = \\frac{\\Sigma f_i x_i}{\\Sigma f_i}" },
          { "label": "Modus Data Berkelompok", "formula": "Mo = L + \\left(\\frac{d_1}{d_1 + d_2}\\right) \\cdot c" },
          { "label": "Median Data Berkelompok", "formula": "Me = L + \\left(\\frac{\\frac{n}{2} - \\Sigma f_k}{f_{me}}\\right) \\cdot c" }
        ],
        "misconceptions": [
    ...
    },
    {
      ...
      "summary": {
        ...
        "keyFormulas": [
          { "label": "Peluang Teoritik Dasar", "formula": "P(A) = \\frac{n(A)}{n(S)}" },
          { "label": "Frekuensi Harapan", "formula": "F_h(A) = N \\times P(A)" },
          { "label": "Kejadian Saling Bebas", "formula": "P(A \\cap B) = P(A) \\times P(B)" }
        ],
        "misconceptions": [
      ...
      "questions": [
        ...
        },
        {
          ...
          "options": [
            { "key": "A", "text": "$\\frac{5}{36}$" },
            { "key": "B", "text": "$\\frac{1}{6}$" },
            { "key": "C", "text": "$\\frac{1}{9}$" },
            { "key": "D", "text": "$\\frac{7}{36}$" }
          ],
          "correctAnswer": "A",
...
with open('src/data/grades/grade10.js', 'w', encoding='utf-8') as f:
    f.write(fileContent)

print("Successfully generated upgraded src/data/grades/grade10.js!")

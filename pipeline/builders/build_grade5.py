  ...
  "chapters": [
    {
      ...
      "summary": {
        ...
        "keyFormulas": [
          { "label": "Nilai Tempat 5 Angka", "formula": "\\text{Puluhan Ribu} \\mid \\text{Ribuan} \\mid \\text{Ratusan} \\mid \\text{Puluhan} \\mid \\text{Satuan}" },
          { "label": "Dekomposisi Bilangan", "formula": "N = a(10.000) + b(1.000) + c(100) + d(10) + e" }
        ],
        "misconceptions": [
      ...
      "questions": [
        {
          ...
          "options": [
            { "key": "A", "text": "Tujuh puluh empat ribu dua puluh lima" },
            { "key": "B", "text": "Tujuh puluh empat ribu dua ratus lima" },
            { "key": "C", "text": "Tujuh puluh empat ribu dua puluh lima ratus" },
            { "key": "D", "text": "Tujuh puluh empat ribu dua ratus lima puluh" }
          ],
          "correctAnswer": "A",
        ...
        },
        {
          ...
          "options": [
            { "key": "A", "text": "$60.000 + 2.000 + 300 + 8$" },
            { "key": "B", "text": "$60.000 + 2.000 + 30 + 8$" },
            { "key": "C", "text": "$6.000 + 200 + 30 + 8$" },
            { "key": "D", "text": "$60.000 + 200 + 300 + 8$" }
          ],
          "correctAnswer": "A",
    ...
    },
    {
      ...
      "summary": {
        ...
        "keyFormulas": [
          { "label": "FPB", "formula": "\\text{Faktor sama pangkat terkecil}" },
          { "label": "KPK", "formula": "\\text{Semua faktor pangkat terbesar}" }
        ],
        "misconceptions": [
      ...
      "questions": [
        {
          ...
          "options": [
            { "key": "A", "text": "$2^2 \\times 3 \\times 5$" },
            { "key": "B", "text": "$2 \\times 3^2 \\times 5$" },
            { "key": "C", "text": "$2 \\times 3 \\times 5$" },
            { "key": "D", "text": "$2^3 \\times 3 \\times 5$" }
          ],
          "correctAnswer": "A",
        ...
        },
        {
          ...
          "options": [
            { "key": "A", "text": "15 kantong" },
            { "key": "B", "text": "10 kantong" },
            { "key": "C", "text": "5 kantong" },
            { "key": "D", "text": "30 kantong" }
          ],
          "correctAnswer": "A",
    ...
    },
    {
      ...
      "summary": {
        ...
        "keyFormulas": [
          { "label": "Penjumlahan Pecahan Beda Penyebut", "formula": "\\frac{a}{b} + \\frac{c}{d} = \\frac{ad + bc}{bd}" },
          { "label": "Perkalian Pecahan Bilangan Asli", "formula": "c \\times \\frac{a}{b} = \\frac{c \\times a}{b}" }
        ],
        "misconceptions": [
      ...
      "questions": [
        ...
        },
        {
          ...
          "options": [
            { "key": "A", "text": "$\\frac{13}{5}$" },
            { "key": "B", "text": "$\\frac{11}{5}$" },
            { "key": "C", "text": "$\\frac{6}{5}$" },
            { "key": "D", "text": "$\\frac{15}{5}$" }
          ],
          "correctAnswer": "A",
        ...
        },
        {
          ...
          "options": [
            { "key": "A", "text": "$\\frac{8}{3}$ atau $2\\frac{2}{3}$" },
            { "key": "B", "text": "$\\frac{8}{12}$" },
            { "key": "C", "text": "$\\frac{6}{3}$" },
            { "key": "D", "text": "$\\frac{2}{12}$" }
          ],
          "correctAnswer": "A",
        ...
        },
        {
          ...
          "options": [
            { "key": "A", "text": "$2\\frac{1}{4}$ meter" },
            { "key": "B", "text": "$2\\frac{1}{2}$ meter" },
            { "key": "C", "text": "$2$ meter" },
            { "key": "D", "text": "$1\\frac{3}{4}$ meter" }
          ],
          "correctAnswer": "A",
    ...
    },
    {
      ...
      "summary": {
        ...
        "keyFormulas": [
          { "label": "Keliling Persegi", "formula": "K = 4 \\times s" },
          { "label": "Keliling Persegi Panjang", "formula": "K = 2 \\times (p + l)" },
          { "label": "Keliling Segitiga", "formula": "K = a + b + c" }
        ],
        "misconceptions": [
    ...
    },
    {
      ...
      "summary": {
        ...
        "keyFormulas": [
          { "label": "Luas Persegi Panjang", "formula": "L = p \\times l" },
          { "label": "Luas Segitiga", "formula": "L = \\frac{1}{2} \\times a \\times t" },
          { "label": "Luas Jajar Genjang", "formula": "L = a \\times t" },
          { "label": "Luas Trapesium", "formula": "L = \\frac{1}{2} \\times (a + b) \\times t" }
        ],
        "misconceptions": [
      ...
      "questions": [
        {
          ...
          "options": [
            ...
            { "key": "B", "text": "$80\\text{ cm}^2$" },
            { "key": "C", "text": "$18\\text{ cm}^2$" },
            { "key": "D", "text": "$36\\text{ cm}^2$" }
          ],
          "correctAnswer": "A",
        ...
        },
        {
          ...
          "options": [
            { "key": "A", "text": "$105\\text{ cm}^2$" },
            { "key": "B", "text": "$44\\text{ cm}^2$" },
            { "key": "C", "text": "$95\\text{ cm}^2$" },
            { "key": "D", "text": "$110\\text{ cm}^2$" }
          ],
          "correctAnswer": "A",
        ...
        },
        {
          ...
          "options": [
            { "key": "A", "text": "$108\\text{ cm}^2$" },
            { "key": "B", "text": "$54\\text{ cm}^2$" },
            { "key": "C", "text": "$42\\text{ cm}^2$" },
            { "key": "D", "text": "$96\\text{ cm}^2$" }
          ],
          "correctAnswer": "A",
        ...
        },
        {
          ...
          "options": [
            { "key": "A", "text": "$128\\text{ cm}^2$" },
            { "key": "B", "text": "$256\\text{ cm}^2$" },
            { "key": "C", "text": "$112\\text{ cm}^2$" },
            { "key": "D", "text": "$144\\text{ cm}^2$" }
          ],
          "correctAnswer": "A",
    ...
    },
    {
      ...
      "summary": {
        ...
        "keyFormulas": [
          { "label": "Sudut per Angka Jam", "formula": "\\frac{360^\\circ}{12} = 30^\\circ" },
          { "label": "Sudut Siku-Siku", "formula": "90^\\circ" },
          { "label": "Sudut Lurus", "formula": "180^\\circ" }
        ],
        "misconceptions": [
      ...
      "questions": [
        {
          ...
          "options": [
            { "key": "A", "text": "Sudut lancip" },
            { "key": "B", "text": "Sudut tumpul" },
            { "key": "C", "text": "Sudut siku-siku" },
            { "key": "D", "text": "Sudut lurus" }
          ],
          "correctAnswer": "A",
        ...
        },
        {
          ...
          "options": [
            { "key": "A", "text": "Sudut tumpul" },
            { "key": "B", "text": "Sudut lancip" },
            { "key": "C", "text": "Sudut siku-siku" },
            { "key": "D", "text": "Sudut lurus" }
          ],
          "correctAnswer": "A",
    ...
    },
    {
      ...
      "summary": {
        ...
        "keyFormulas": [
          { "label": "Simetri Persegi", "formula": "4 \\text{ lipat, } 4 \\text{ putar}" },
          { "label": "Simetri Persegi Panjang", "formula": "2 \\text{ lipat, } 2 \\text{ putar}" }
        ],
        "misconceptions": [
      ...
      "questions": [
        {
          ...
          "options": [
            ...
            { "key": "C", "text": "Persegi panjang" },
            { "key": "D", "text": "Jajar genjang" }
          ],
          "correctAnswer": "A",
        ...
        },
        {
          ...
          "options": [
            { "key": "A", "text": "Memiliki 2 simetri putar dan 0 simetri lipat" },
            { "key": "B", "text": "Memiliki 2 simetri lipat dan 2 simetri putar" },
            { "key": "C", "text": "Memiliki 4 simetri putar" },
            { "key": "D", "text": "Kedua diagonalnya berpotongan tegak lurus" }
          ],
          "correctAnswer": "A",
    ...
    },
    {
      ...
      "summary": {
        ...
        "keyFormulas": [
          { "label": "Konversi Piktogram", "formula": "\\text{Total Data} = \\text{Banyak Simbol} \\times \\text{Nilai Per Simbol}" },
          { "label": "Selisih Data", "formula": "\\text{Selisih} = \\text{Nilai Terbanyak} - \\text{Nilai Terkecil}" }
        ],
        "misconceptions": [
    ...
    },
    {
      ...
      "summary": {
        ...
        "keyFormulas": [
          { "label": "Nilai Satu Juta", "formula": "1.000.000 = 10 \\times 100.000 = 1.000 \\times 1.000" },
          { "label": "Hierarki Tempat", "formula": "\\text{Jutaan} \\mid \\text{Ratusan Ribu} \\mid \\text{Puluhan Ribu} \\dots" }
        ],
        "misconceptions": [
      ...
      "questions": [
        {
          ...
          "options": [
            { "key": "A", "text": "Rp750.000,00" },
            { "key": "B", "text": "Rp75.000,00" },
            { "key": "C", "text": "Rp7.500.000,00" },
            { "key": "D", "text": "Rp705.000,00" }
          ],
          "correctAnswer": "A",
        ...
        },
        {
          ...
          "options": [
            { "key": "A", "text": "Ratusan ribu" },
            { "key": "B", "text": "Puluhan ribu" },
            { "key": "C", "text": "Jutaan" },
            { "key": "D", "text": "Ribuan" }
          ],
          "correctAnswer": "A",
        ...
        },
        {
          ...
          "options": [
            { "key": "A", "text": "Rp225.000,00" },
            { "key": "B", "text": "Rp250.000,00" },
            { "key": "C", "text": "Rp275.000,00" },
            { "key": "D", "text": "Rp215.000,00" }
          ],
          "correctAnswer": "A",
...
with open('src/data/grades/grade5.js', 'w', encoding='utf-8') as f:
    f.write(fileContent)

print("Successfully generated upgraded src/data/grades/grade5.js!")

  ...
  "chapters": [
    {
      ...
      "summary": {
        ...
        "keyFormulas": [
          { "label": "Komposisi Fungsi", "formula": "(f \\circ g)(x) = f(g(x))" },
          { "label": "Invers Pecahan Linear", "formula": "f(x) = \\frac{ax + b}{cx + d} \\implies f^{-1}(x) = \\frac{-dx + b}{cx - a} \\quad \\left(x \\neq \\frac{a}{c}\\right)" },
          { "label": "Invers Komposisi Berbalik", "formula": "(f \\circ g)^{-1}(x) = (g^{-1} \\circ f^{-1})(x)" },
          { "label": "Identitas Komposisi Invers", "formula": "(f \\circ f^{-1})(x) = (f^{-1} \\circ f)(x) = x" }
        ],
        "misconceptions": [
      ...
      "questions": [
        ...
        },
        {
          ...
          "options": [
            { "key": "A", "text": "$\\frac{x - 7}{3}$" },
            { "key": "B", "text": "$\\frac{x + 7}{3}$" },
            { "key": "C", "text": "$3x - 7$" },
            { "key": "D", "text": "$\\frac{7 - x}{3}$" }
          ],
          "correctAnswer": "A",
        ...
        },
        {
          ...
          "options": [
            { "key": "A", "text": "$f^{-1}(x) = \\frac{-4x - 2}{5x - 3}$" },
            { "key": "B", "text": "$f^{-1}(x) = \\frac{4x - 2}{5x + 3}$" },
            { "key": "C", "text": "$f^{-1}(x) = \\frac{5x + 4}{3x - 2}$" },
            { "key": "D", "text": "$f^{-1}(x) = \\frac{-3x - 2}{5x - 4}$" }
          ],
          "correctAnswer": "A",
        ...
        },
        {
          ...
          "options": [
            { "key": "A", "text": "$2x^2 - 3x + 2$" },
            { "key": "B", "text": "$2x^2 - 3x + 4$" },
            { "key": "C", "text": "$4x^2 - 6x + 4$" },
            { "key": "D", "text": "$2x^2 + 3x + 2$" }
          ],
          "correctAnswer": "A",
    ...
    },
    {
      ...
      "summary": {
        ...
        "keyFormulas": [
          { "label": "Teorema Sudut Pusat & Keliling", "formula": "\\angle \\text{Pusat} = 2 \\times \\angle \\text{Keliling} \\quad (\\text{menghadap busur yang sama})" },
          { "label": "Segiempat Tali Busur", "formula": "\\angle A + \\angle C = 180^\\circ \\quad \\text{dan} \\quad \\angle B + \\angle D = 180^\\circ" },
          { "label": "Garis Singgung Persekutuan Luar", "formula": "d_L = \\sqrt{p^2 - (R - r)^2} \\quad (p > R - r)" },
          { "label": "Garis Singgung Persekutuan Dalam", "formula": "d_D = \\sqrt{p^2 - (R + r)^2} \\quad (p > R + r)" }
        ],
        "misconceptions": [
      ...
      "questions": [
        ...
        },
        {
          ...
          "options": [
            { "key": "A", "text": "$102^\\circ$ dan $75^\\circ$" },
            { "key": "B", "text": "$75^\\circ$ dan $102^\\circ$" },
            { "key": "C", "text": "$112^\\circ$ dan $65^\\circ$" },
            { "key": "D", "text": "$92^\\circ$ dan $85^\\circ$" }
          ],
          "correctAnswer": "A",
        ...
        },
        {
          ...
          "options": [
            ...
            { "key": "C", "text": "$\\sqrt{144}\\text{ cm}$" },
            { "key": "D", "text": "$14\\text{ cm}$" }
          ],
          "correctAnswer": "A",
        ...
        },
        {
          ...
          "options": [
            { "key": "A", "text": "$24\\text{ cm}$" },
            { "key": "B", "text": "$20\\text{ cm}$" },
            { "key": "C", "text": "$25\\text{ cm}$" },
            { "key": "D", "text": "$18\\text{ cm}$" }
          ],
          "correctAnswer": "A",
    ...
    },
    {
      ...
      "summary": {
        ...
        "keyFormulas": [
          { "label": "Model Persamaan Regresi", "formula": "\\hat{y} = a + bx" },
          { "label": "Gradien Kemiringan Regresi", "formula": "b = \\frac{n\\Sigma xy - (\\Sigma x)(\\Sigma y)}{n\\Sigma x^2 - (\\Sigma x)^2}" },
          { "label": "Intersep Sumbu-Y Regresi", "formula": "a = \\bar{y} - b\\bar{x}" },
          { "label": "Koefisien Korelasi Pearson", "formula": "r = \\frac{n\\Sigma xy - (\\Sigma x)(\\Sigma y)}{\\sqrt{[n\\Sigma x^2 - (\\Sigma x)^2][n\\Sigma y^2 - (\\Sigma y)^2]}} \\quad (-1 \\le r \\le 1)" },
          { "label": "Koefisien Determinasi", "formula": "R^2 = r^2 \\times 100\\%" }
        ],
        "misconceptions": [
      ...
      "questions": [
        {
          ...
          "options": [
            { "key": "A", "text": "Korelasi positif" },
            { "key": "B", "text": "Korelasi negatif" },
            { "key": "C", "text": "Tidak berkorelasi" },
            { "key": "D", "text": "Korelasi konstan" }
          ],
          "correctAnswer": "A",
        ...
        },
        {
          ...
          "options": [
            { "key": "A", "text": "$-1 \\le r \\le 1$" },
            { "key": "B", "text": "$0 \\le r \\le 1$" },
            { "key": "C", "text": "$-1 < r < 0$" },
            { "key": "D", "text": "$r \\ge 0$" }
          ],
          "correctAnswer": "A",
        ...
        },
        {
          ...
          "options": [
            { "key": "A", "text": "Permintaan berkurang sebanyak 15 lusin" },
            { "key": "B", "text": "Permintaan bertambah sebanyak 15 lusin" },
            { "key": "C", "text": "Permintaan berkurang sebanyak 5 lusin" },
            { "key": "D", "text": "Permintaan tidak berubah" }
          ],
          "correctAnswer": "A",
...
with open('src/data/grades/grade11.js', 'w', encoding='utf-8') as f:
    f.write(fileContent)

print("Successfully generated upgraded src/data/grades/grade11.js!")
